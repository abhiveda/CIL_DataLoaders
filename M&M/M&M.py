...
from basic_operations import switch_kv_in_dict, intensity_norm_fn_selector
from data_structure import Cache
from basic_operations import load_img_label_from_path, crop_or_pad, rescale_intensity


class BaseSegDataset(Dataset):
    def __init__(self, root_dir, image_format_name, label_format_name, dataset_name, transform, image_size, label_size,
                 idx2cls_dict=None, num_classes=2,
                 use_cache=False, formalized_label_dict=None, keep_orig_image_label_pair=False, ignore_black_slice=True,
                 maximum_cache_size=20, intensity_norm_type='min_max',
...
if __name__ == '__main__':
    ...
    dataset = BaseSegDataset(dataset_name='dummy', image_size=image_size, label_size=label_size, transform=tr['train'],
                             use_cache=True)
    dataset_2 = BaseSegDataset(dataset_name='dummy', image_size=image_size, label_size=label_size,
                               transform=tr['train'],
                               use_cache=True)
